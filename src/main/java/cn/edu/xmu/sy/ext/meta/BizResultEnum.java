...
public enum BizResultEnum implements IResultEnum {
    ...
    FINGERPRINT_ENROLL_MAX_COUNT(20204, "此用户已登记{0}枚指纹."),
    FINGERPRINT_ENROLL_ERROR(20205, "登记指纹失败."),
    FINGERPRINT_UID_NOT_EXIST(20206, "UID为{0,number,#}的指纹不存在."),
    FINGERPRINT_IDENTIFY_ERROR(20207, "辨识指纹失败."),
