...
public class DataImporter {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("/home/luoxin/桌面/333.csv"))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (!data[3].equals("NULL")) {
                    ...
                    fingerprint.setUuid(UUIDUtil.randomHexUUID());
                    fingerprint.setFinger("未知");
    ...
    public void synthesizeUserNameVoice() throws Exception {
        List<UserDO> users = userMapper.listByPaging(0L, 1000);
        List<String> names = users.stream()
                .map(UserDO::getName)
                .collect(Collectors.toList());
        ttsService.ttsBatchSync(null, names, false);
    }
}
